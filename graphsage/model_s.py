...
def train(feats, G, all_pairs, tflag, pmos_types, nmos_types):
    ...
    enc3=GNN(feat_dim,hidden_dim,hidden_dim,3,0.5)
    ...
    for e in range(epoch):
        for i in range(num_batch):
            ...
            test_output = torch.sigmoid(graphsage(features, adj_lists, test_pair1, test_pair2))
            ...
            score=f1_score(np.asarray(test_label), pred)
            ...
            print("The {}-th epoch, The {}-th batch, ".format(e, i), "Loss: {}, score:{}".format(loss.item(),score.item()))
